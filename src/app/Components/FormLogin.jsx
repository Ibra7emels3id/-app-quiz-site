        ...
        try {
            if (DataGrade) {
                ...
                if (data.data.role === 'user') {
                    window.location.href = `/quiz/${DataGrade}`
                }
            } else {
        ...
        <>
            <form className="space-y-4">
                ...
                <p className="text-sm !mt-8 text-center text-gray-800">
                    Request to apply I am not logged in{" "}
                    <Link
                        href="/"
